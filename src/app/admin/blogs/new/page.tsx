...
export default function NewBlogPage() {
  ...
  const handleSubmit = async (action: 'draft' | 'publish') => {
    ...
    try {
      ...
      const createdBlog = await blogApi.createBlog(blogData);

      toast.success(`Blog ${action === 'publish' ? 'created and published' : 'created and saved as draft'} successfully!`);
      router.push(`/admin/blogs/edit/${createdBlog.id}`);
    } catch (error: any) {
    ...
    <AdminLayout>
      <div className="new-blog-page">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h1 className="h3 mb-0">Create New Blog Post</h1>
